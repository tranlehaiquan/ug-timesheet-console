...
const pillTabs = [{ id: 'calendar', name: 'Calendar' }, { id: 'swimlane', name: 'Swimlane' }, { id: 'swimlane-vertical', name: 'Swimlane vertical' }, { id: 'map', name: 'Map' }]
...
const inlineTabs = [
  { id: 'overview', name: 'Overview', submenu: availabilitySubmenu.map(a => ({ name: `${a.name} overview`, id: `overview-${a.id}` })) },
  { id: 'schedule', name: 'schedule' },
  { id: 'jobs', name: 'jobs', icon: '3', submenu: availabilitySubmenu.map(a => ({ ...a, name: `Jobs ${a.name}` })) },
  { id: 'map', name: 'Map' },
