...
export const EmptyState: React.SFC<IEmptyState> = ({ imgSrc, title, message, className, children, ...otherProps }) => {
  return (
    <div className={ classnames('sk-text-center sk-leading-normal', className) } { ...otherProps }>
