...
type ReactDatePickerPropsSubset = Pick<ReactDatePickerProps, 'showTimeSelect' | 'showTimeSelectOnly'>
...
const DefaultInput = React.forwardRef(({ onChange, onClick, disabled, placeholder, value }: React.InputHTMLAttributes<HTMLInputElement | SVGElement>, ref) => (
...
const selectDates = (onChange: (date: Date) => void, onWeekSelect: (dates: Date[]) => void, selectWeek: boolean) => (date: Date) => {
...
export const Datepicker: React.FC<IDatepickerProps> = ({
  ...
  const highlightedDates = [
    { 'react-datepicker__day--week-selected': selectedWeekDates } as HighlightDates,
    { 'react-datepicker__day--week-hovered': highlightedWeekDates } as HighlightDates,
    ...highlightDates
  ]
