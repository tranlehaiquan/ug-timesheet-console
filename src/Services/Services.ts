...
const getCredential = () => {
  return {
    ...
    apiServer: import.meta.env.VITE_API_SERVER || skedInjected?.credentials?.apiServer,
    apiAccessToken: import.meta.env.VITE_API_ACCESS_TOKEN || skedInjected?.credentials?.apiAccessToken
  }
}
