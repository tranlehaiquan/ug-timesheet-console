...
export type UpdateStatusModalProps = SingleUpdateModalProps | BatchUpdateModalProps | NoUpdateModalProps
export type { Action as SingleUpdateModalAction } from './SingleUpdateModal'

export default (props: UpdateStatusModalProps) => {
  if (!props.isOpened) return null
  if (props.timesheetsToUpdateCount === 0) return <NoUpdateModal { ...(props as NoUpdateModalProps) } />
  if (props.timesheetsCount === 1) return <SingleUpdateModal { ...(props as SingleUpdateModalProps) } />
