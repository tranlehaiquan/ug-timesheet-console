...
*/
export const Icon = ({ name, className, size, onClick, ...otherProps }: IProps) => {
  const Component = icons[name]
  return <Component { ...otherProps } height={ size || DEFAULT_SIZE } width={ size || DEFAULT_SIZE } onClick={ onClick } className={ classNames('sk-flex-no-shrink sk-fill-current', className) } />
}
