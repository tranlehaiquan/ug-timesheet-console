...
import { SkedFormValidation, SkedFormValidationState } from './SkedFormValidation'
...
describe('SkedFormValidation', () => {
  ...
  test('tracks modified fields, adds only on input value change', () => {
    ...
    const wrapper = mount<{}, SkedFormValidationState<{}>>(
      <SkedFormValidation config={ config } onSubmit={ onSubmit } initialValues={ { test: '' } }>
  ...
  test('will set fields if initialValues change', () => {
    // Arrange
    const wrapper = mount<{}, SkedFormValidationState<{}>>(
      <SkedFormValidation config={ { test: {} } } onSubmit={ onSubmit } initialValues={ {} }>
        { ({ fields }) => (
          <FormElementWrapper>
            <FormInputElement onChange={ noop } name="test" type="text" value={ fields.test } data-sk-name="TestInput" />
          </FormElementWrapper>
        ) }
      </SkedFormValidation>
    )
  ...
  describe('submit', () => {
    test('wont set form back to read only if normal form', () => {
      // Arrange
      const wrapper = mount<{}, SkedFormValidationState<{}>>(
        <SkedFormValidation config={ { test: {} } } onSubmit={ onSubmit } initialValues={ { test: 'Hello' } }>
          { ({ fields, isFormReadonly, submit }) => (
            <>
              <FormElementWrapper readOnlyValue={ fields.test } isReadOnly={ isFormReadonly }>
                <FormInputElement onChange={ noop } name="test" type="text" value={ fields.test } data-sk-name="TestInput" />
              </FormElementWrapper>
      ...
      firstInput.simulate('change', { target: { name: 'test', value: 'updated value' } })
    ...
    test('submit with a Promise', () => {
      ...
      // Arrange
      const wrapper = mount<{}, SkedFormValidationState<{}>>(
        <SkedFormValidation config={ { test: {} } } onSubmit={ submit } initialValues={ { test: 'Hello' } }>
          { ({ fields, isFormReadonly, submit }) => (
            <>
              <FormElementWrapper readOnlyValue={ fields.test } isReadOnly={ isFormReadonly }>
                <FormInputElement onChange={ noop } name="test" type="text" value={ fields.test } data-sk-name="TestInput" />
    ...
    test('regular submit', () => {
      ...
      const wrapper = mount<{}, SkedFormValidationState<{}>>(
        <SkedFormValidation config={ { test: {} } } onSubmit={ onSubmit } initialValues={ { test: 'Hello' } }>
          { ({ fields, isFormReadonly, submit }) => (
            <>
              <FormElementWrapper readOnlyValue={ fields.test } isReadOnly={ isFormReadonly } data-sk-name="form-element-wrapper">
                <FormInputElement onChange={ noop } name="test" type="text" value={ fields.test } />
              </FormElementWrapper>
              { !isFormReadonly && <Button onClick={ submit }>Cancel</Button> }
            </>
          ) }
  ...
  describe('resetFieldsToInitialValues', () => {
    test('will reset form back to initial values', () => {
      ...
      const wrapper = mount(
        <SkedFormValidation config={ { test: {} } } onSubmit={ onSubmit } initialValues={ initialValues }>
          { ({ fields, isFormReadonly, resetFieldsToInitialValues }) => (
            <>
              <FormElementWrapper readOnlyValue={ fields.test } isReadOnly={ isFormReadonly }>
                <FormInputElement onChange={ noop } name="test" type="text" value={ fields.test } />
              </FormElementWrapper>
              { !isFormReadonly && <Button onClick={ resetFieldsToInitialValues }>Cancel</Button> }
            </>
          ) }
        </SkedFormValidation>
      )
      ...
      // Act
      const firstInput = wrapper.find(FormInputElement).first()
      firstInput.simulate('change', { target: { name: 'test', value: 'New Value' } })
  ...
  describe('Click to edit', () => {
    test('clicking a readOnly field toggles editable mode, calling "setFormReadOnly" will show readOnly', () => {
      // Arrange
      const wrapper = mount(
        <SkedFormValidation config={ config } onSubmit={ onSubmit } initialValues={ { test: 'Hello world' } } options={ { clickToEdit: true } }>
          { ({ fields, isFormReadonly, setFormReadonly }) => (
            <>
              <FormElementWrapper readOnlyValue={ fields.test } isReadOnly={ isFormReadonly } data-sk-name="form-element-wrapper">
                <FormInputElement type="text" value={ fields.test } onChange={ noop } />
              </FormElementWrapper>
              <FormElementWrapper readOnlyValue={ fields.test } isReadOnly={ isFormReadonly } data-sk-name="form-element-wrapper">
                <FormInputElement type="text" value={ fields.anotherTest } onChange={ noop } />
              </FormElementWrapper>
    ...
    test('submitting form updates the initial value state, and sets the field back to read only', () => {
      ...
      const initialValues = { test: 'Hello world' }
      const wrapper = mount<{}, SkedFormValidationState<{}>>(
        <SkedFormValidation config={ { test: {} } } onSubmit={ onSubmit } initialValues={ initialValues } options={ { clickToEdit: true } } data-sk-name="form-element-wrapper">
          { ({ fields, isFormReadonly, submit }) => (
            <>
              <FormElementWrapper readOnlyValue={ fields.test } isReadOnly={ isFormReadonly }>
                <FormInputElement onChange={ noop } name="test" type="text" value={ fields.test } />
      ...
      // Act
      wrapper.find('[data-sk-name="form-element-wrapper"]').simulate('click', { target: { getAttribute: () => 'true' } })
      ...
      return Promise.resolve(() => {
        ...
        expect(wrapper.find('[data-sk-name="form-element-wrapper"]')).toHaveLength(1)
      })
    })
  })
})
