...
describe("Modal", () => {
  ...
  describe("ConfirmationModal", () => {
    ...
    test("calls confirm prop function", () => {
      ...
      const wrapper = shallow(
        <ConfirmationModal onCancel={noop} onConfirm={confirmSpy}>
          Some content
        </ConfirmationModal>
      );
    ...
    test("calls cancel prop function", () => {
      ...
      const wrapper = shallow(
        <ConfirmationModal onCancel={cancelSpy} onConfirm={noop}>
          Some content
        </ConfirmationModal>
      );
    ...
    test("uses supplied confirm button text", () => {
      const wrapper = shallow(
        <ConfirmationModal
          onCancel={noop}
          onConfirm={noop}
          confirmButtonText="I work"
        >
          Some content
        </ConfirmationModal>
      );
      expect(
        wrapper.find('[data-sk-name="confirm-button"]').dive().text()
      ).toEqual("I work<LoadingSpinner />");
    });
  });
});
