...
export const TableRows: <T>(props: ITableRowsProps<T>) => React.ReactElement<ITableRowsProps<T>> = ({
  data,
  config,
  selection,
  onSelect,
  ...
  const selectBy = Option.of(config).next('options').next('selectable').next('selectBy').getOrElse(null)
