...
describe("PaginationPages", () => {
  it("renders Pagination pages elements without truncated items", () => {
    ...
    expect(
      wrapper.find('[data-sk-name="pagination-pages-container"]').length
    ).toBe(1);
    expect(
      wrapper.find('[data-sk-name="pagination-pages-arrow-left"]').length
    ).toBe(1);
    expect(
      wrapper.find('[data-sk-name="pagination-pages-arrow-right"]').length
    ).toBe(1);
    expect(
      wrapper.find('[data-sk-name="pagination-pages-item-number"]').length
    ).toBe(6);
    expect(
      wrapper.find('[data-sk-name="pagination-pages-item-number-current"]')
        .length
    ).toBe(1);
    expect(
      wrapper.find('[data-sk-name="pagination-pages-item-truncated"]').length
    ).toBe(0);
  });
  ...
  it("disables back arrow when current page is set as first", () => {
    ...
    expect(
      wrapper
        .find('[data-sk-name="pagination-pages-arrow-left"]')
        .hasClass("sk-cursor-not-allowed")
    ).toBe(true);
    expect(
      wrapper
        .find('[data-sk-name="pagination-pages-arrow-right"]')
        .hasClass("sk-cursor-not-allowed")
    ).toBe(false);
  });
