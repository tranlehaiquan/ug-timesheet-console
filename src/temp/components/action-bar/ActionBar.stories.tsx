...
import { ActionBar, ActionBarActions, ActionBarViewControls } from './ActionBar'
  ...
  .add(
    ...
    () => {
      return (
        ...
        >
          <ActionBarActions>
            <Button buttonType="transparent" compact>Any Btn</Button>
            <Button buttonType="transparent" compact>Any Btn</Button>
          </ActionBarActions>
          <ActionBarViewControls withSearch={ false }>
            ...
            >
              <Menu>
                ...
                <MenuItem>
                  Button dropdown children 2
                </MenuItem>
                <MenuItem>
                  This is a long list item that extends past the maxWidth of the dropdown
                </MenuItem>
              </Menu>
            </ButtonDropdown>
            <ButtonDropdown
