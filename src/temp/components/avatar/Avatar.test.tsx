...
describe("Avatar", () => {
  ...
  it("should use supplied tooltip text", () => {
    const avatar = shallow(
      <Avatar name="Darlene" showTooltip tooltipText="Hello" />
    );
  ...
  it("applies correct sizing classes", () => {
    ...
    expect(avatar.find('[data-sk-name="test"]').hasClass("sked-avatar")).toBe(
      true
    );

    avatar.setProps({ size: "tiny" });
    expect(
      avatar.find('[data-sk-name="test"]').hasClass("sked-avatar--tiny")
    ).toBe(true);

    avatar.setProps({ size: "small" });
    expect(
      avatar.find('[data-sk-name="test"]').hasClass("sked-avatar--small")
    ).toBe(true);

    avatar.setProps({ size: "large" });
    expect(
      avatar.find('[data-sk-name="test"]').hasClass("sked-avatar--large")
    ).toBe(true);
  });
});
