...
interface IActionBarSearchItemProps extends React.HTMLAttributes<HTMLInputElement> {
  /**
...
export const ActionBarSearchItem: React.FC<IActionBarSearchItemProps> = React.forwardRef((props, ref) => {
