...
describe("PopOut", () => {
  test("renders with correct initial state", () => {
    ...
    const component = shallow<PopOut>(
      <PopOut trigger={<div>Popping out!</div>}>Hi</PopOut>
    );
  ...
  test("display popout when trigger clicked", () => {
    // Arrange
    const component = mount<PopOut>(
      <PopOut trigger={<div data-sk-name="popout-trigger">Popping out!</div>}>
        <div data-sk-name="popout-child">child popout content</div>
      </PopOut>
    );
